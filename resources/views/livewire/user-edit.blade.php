<div class="space-y-8 px-4 py-14 lg:px-10 lg:py-10">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Edit Akun Petugas</h2>
            <p class="text-sm text-slate-500 mt-1">Perbarui informasi dan hak akses akun petugas.</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-8 border-b border-slate-50">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400">Data resmi sesuai KTP petugas.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- NIK --}}
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Nomor Induk Kependudukan (NIK)</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-primary transition-colors">
                            ...
                            <input
                                ...
                                class="block w-full pl-11 pr-4 py-3 bg-slate-50 border @error('nik') border-red-400 @else border-slate-200 @enderror rounded-xl text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary focus:bg-white transition-all">
                        </div>
            ...
            <div class="p-8 bg-slate-50/30">
                <div class="flex items-center gap-3 mb-8">
                    <div class="w-10 h-10 bg-secondary/10 text-secondary rounded-xl flex items-center justify-center shadow-sm">
                        <i class="fas fa-key text-lg"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-slate-700">Kredensial Login & Akses</h3>
                        <p class="text-xs text-slate-400">Kosongkan kata sandi jika tidak ingin mengubahnya.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- EMAIL --}}
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Email Instansi</label>
                        <div class="relative group">
                    ...
                    {{-- NO HP --}}
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Nomor HP</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-secondary transition-colors">
                    ...
                    {{-- ROLE --}}
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Level Akses (Role)</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-primary transition-colors">
                            ...
                            <select
                                wire:model="role"
                                class="block w-full pl-11 pr-10 py-3 bg-white border border-slate-200 rounded-xl text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary cursor-pointer transition-all">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input
                                ...
                                class="block w-full pl-11 pr-11 py-3 bg-white border @error('password') border-red-400 bg-red-50 @else border-slate-200 @enderror rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary transition-all">
                            <button
                                type="button"
                                wire:click="togglePassword"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-primary transition">
            ...
            {{-- FOOTER ACTIONS --}}
            <div class="p-6 bg-slate-100/50 flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-2 text-slate-400">
                    <i class="fas fa-shield-check text-secondary"></i>
                    <p class="text-[11px] leading-tight">
                        Data ini akan digunakan sebagai kredensial login resmi.<br>Pastikan email aktif.
                    </p>
                </div>
                <div class="flex items-center gap-3 w-full md:w-auto">
                    <a href="{{ route('users.index') }}"
                        class="flex-1 md:flex-none px-6 py-3 text-sm font-bold text-slate-500 hover:text-slate-700 transition-all text-center">
                        Batal
                    </a>
                    <button
                        wire:click="save"
